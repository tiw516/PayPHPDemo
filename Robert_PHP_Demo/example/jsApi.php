...
$input->setChannel("Wechat");
$input->setNotifyUrl("https://www.your_domain.com/notify");
$input->setOperator("wechat jsapi");
...
<head>
    ...
    <title>AlphaPay支付样例-微信jsApi支付</title>
    <script>
...
<div align="center">
    <button
        ...
        type="button"
        onclick="redirect('<?php echo AlphaPayApi::getJsApiRedirectUrl($result['pay_url'], $inputObj); ?>')">
        立即支付
    </button>
</div>
</body>

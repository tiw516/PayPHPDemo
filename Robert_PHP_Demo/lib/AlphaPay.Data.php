...
class AlphaPayDataBase
{
    ...
    {
        $buff = "";
        $buff .= AlphaPayConfig::PARTNER_CODE . '&' . $this->getTime() . '&' . $this->getNonceStr() . "&" . AlphaPayConfig::CREDENTIAL_CODE;
        return $buff;
    }
 ...
 *
 */
class AlphaPayResults extends AlphaPayDataBase
{
 ...
 * @author Leijid
 */
class AlphaPayMicropayOrder extends AlphaPayUnifiedOrder
{
    /**
     * 设置设备ID
     * @param string $value
 ...
 * 线下QRCode支付单
 */
class AlphaPayRetailQRCode extends AlphaPayUnifiedOrder
{
    /**
     * 设置设备ID
     * @param string $value
 ...
 * @author Leijid
 */
class AlphaPayOrderQuery extends AlphaPayDataBase
{
    /**
     * 设置商户支付订单号，同一商户唯一
     * @param string $value
 ...
 * @author Leijid
 */
class AlphaPayApplyRefund extends AlphaPayDataBase
{
    /**
     * 设置商户支付订单号，同一商户唯一
     * @param string $value
 ...
 * @author Leijid
 */
class AlphaPayQueryRefund extends AlphaPayDataBase
{
    /**
     * 设置商户支付订单号，同一商户唯一
     * @param string $value
 ...
 * @author Leijid
 */
class AlphaPayQueryOrders extends AlphaPayDataBase
{
    /**
